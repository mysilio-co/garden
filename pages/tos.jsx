    ...
    <LeftNavLayout pageTitle="Terms of Use">
      <div className="p-6 bg-my-green text-white">
        <article className="prose prose-invert">
          <h3>Last updated February 09, 2021</h3>
          <h2>Hi!</h2>
          <p>
            These are our Terms of Use. We generated them using{' '}
            <a href="https://termly.io/products/terms-and-conditions-generator/">
              Termly
            </a>
            . They're legally binding but{' '}
            <a href="https://github.com/mysilio/garden/issues">
              open for discussion
            </a>{' '}
            - we'd like to know if any of them stop you from using our site. The
            good news is many of them probably don't apply if you're using a
            third party Solid Pod, and we'll be working with our lawyers to make
            sure they better reflect our values and liabilities soon. In the
            mean time, the important takeaway is: please don't be a jerk on our
            platform.
          </p>
          <p>
            These Terms of Use constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity ("you")
            and Mysilio Co, doing business as mysilio.garden ("
            <strong>mysilio.garden</strong>", "<strong>we</strong>", "
            <strong>us</strong>", or "<strong>our</strong>"), concerning your
            access to and use of the mysilio.garden website as well as any other
          ...
          <h3>
            <a name="_4rd71iod99ud"></a>INTELLECTUAL PROPERTY RIGHTS
          </h3>
          <p>
          ...
          <h3>
            <a name="_vhkegautf00d"></a>USER REPRESENTATIONS
          </h3>
          <p>
            ...
            comply with these Terms of Use; (4) you are not under the age of
            13;&nbsp;(5) you are not a minor in the jurisdiction in which you
            reside, or if a minor, you have received parental permission to use
            the Site; (6) you will not access the Site through automated or
            non-human means, whether through a bot, script, or otherwise; (7)
            you will not use the Site for any illegal or unauthorized purpose;
            and (8) your use of the Site will not violate any applicable law or
            regulation.
          </p>
          <p>
          ...
          <h3>
            <a name="_esuoutkhaf53"></a>USER REGISTRATION
          </h3>
          <p>
          ...
          <h3>
            <a name="_1voziltdxegg"></a>PROHIBITED ACTIVITIES
          </h3>
          <p>
          ...
          <h3>
            <a name="_zbbv9tgty199"></a>USER GENERATED CONTRIBUTIONS
          </h3>
          <p>
          ...
          <h3>
            <a name="_29ce8o9pbtmi"></a>SITE MANAGEMENT
          </h3>
          <p>
          ...
          <h3>
            <a name="_jugvcvcw0oj9">PRIVACY POLICY</a>
          </h3>
          <p>
          ...
          <h3>
            <a name="_k3mndam4w6w1"></a>TERM AND TERMINATION
          </h3>
          <p>
          ...
          <h3>
            <a name="_e2dep1hfgltt"></a>MODIFICATIONS AND INTERRUPTIONS
          </h3>
          ...
          <h3>
            <a name="_p6vbf8atcwhs"></a>GOVERNING LAW
          </h3>
          <p>
          ...
          <h3>
            <a name="_v5i5tjw62cyw"></a>DISPUTE RESOLUTION
          </h3>
          ...
          <h4>
            <a name="_p2enhfx5sw3j"></a>Binding Arbitration
          </h4>
          <p>
            ...
            Alameda, California. Except as otherwise provided herein, the
          ...
          <p>
            ...
            state and federal courts located in Alameda, California, and the
          ...
          <h4>
            <a name="_inlv5c77dhih"></a>Restrictions
          </h4>
          <p>
          ...
          <h4>
            <a name="_mdjlt1af25uq"></a>Exceptions to Informal Negotiations and
            Arbitration
          </h4>
          <p>
          ...
          <h3>
            <a name="_mjgzo07ttzx5"></a>CORRECTIONS
          </h3>
          <p>
          ...
          <h3>
            <a name="_gvi74blrahf9"></a>DISCLAIMER
          </h3>
          <p>
          ...
          <h3>
            <a name="_4pjah3d0455q"></a>LIMITATIONS OF LIABILITY
          </h3>
          <p>
          ...
          <h3>
            <a name="_k5ap68aj1dd4"></a>INDEMNIFICATION
          </h3>
          <p>
          ...
          <h3>
            <a name="_ftgg17oha0ep"></a>USER DATA
          </h3>
          <p>
          ...
          <h3>
            <a name="_dkovrslqodui"></a>ELECTRONIC COMMUNICATIONS, TRANSACTIONS,
            AND SIGNATURES
          </h3>
          <p>
          ...
          <h3>
            <a name="_cem9cu2usl7k"></a>CALIFORNIA USERS AND RESIDENTS
          </h3>
          <p>
          ...
          <h3>
            <a name="_d4jvmcnxg0wt"></a>MISCELLANEOUS
          </h3>
          <p>
          ...
          <p>
            You may receive access to mysilio.garden while the software is still
            in development and before we have done thorough testing on the
            platform. As a result and notwithstanding anything to the contrary
            in this agreement or any other agreement between you and Mysilio Co:
            (a) you may use or decline to use mysilio.garden; (b) mysilio.garden
            may not be supported and may be changed at any time without notice
            to you; (c) mysilio.garden may not be as reliable or available as
            other commercially available products or services; (d)
            mysilio.garden has not been subjected to the same security measures
            and auditing to which other software products or services may have
            been subjected; and (e) MYSILIO CO WILL HAVE NO LIABILITY ARISING
            OUT OF OR IN CONNECTION WITH YOUR USE OF THE MYSILIO.GARDEN
            PLATFORM&mdash;USE AT YOUR OWN RISK.
          </p>

          <h3>
            <a name="_t4pq5cwn486q"></a>CONTACT US
          </h3>
          <p>
          ...
          <p>
            Mysilio Co <br />
            3871 Piedmont Ave #374 <br />
            Oakland, CA 94611 <br />
            United States <br />
            <a href="mailto:hello@mysilio.com">hello@mysilio.com</a>
          </p>
        </article>
      </div>
    </LeftNavLayout>
